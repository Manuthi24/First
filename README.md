...
- Polished, production-like UI with branded hero, KPI cards, sidebar controls, and suggested prompts
...
4. **UI Theme (`.streamlit/config.toml`)**
   - Branded color theme for a deployment-style look

5. **Testing (`tests/test_api.py`)**
   - Health check test
